// Generated by @wagmi/cli@0.1.10 on 3/26/2023 at 11:26:02 PM
import {
  useNetwork,
  useContract,
  UseContractConfig,
...
/**
 * - [__View Contract on Optimism Goerli Etherscan__](https://goerli-optimism.etherscan.io/address/0x7ae3772901ea231949423089d324f1c088172C5e)
 * -
 */
export const bountiesAttestorABI = [
  {
    stateMutability: 'nonpayable',
    type: 'constructor',
    inputs: [
      { name: '_globalAdmin', internalType: 'address', type: 'address' },
      {
        name: '_attestationStatoin',
        internalType: 'contract AttestationStation',
        type: 'address',
      },
    ],
  },
  { type: 'error', inputs: [], name: 'AddressNotAuthorized' },
  {
    stateMutability: 'view',
    type: 'function',
    inputs: [],
  ...
  },
  {
    ...
    type: 'function',
    inputs: [
      { name: 'group', internalType: 'bytes32', type: 'bytes32' },
      { name: 'account', internalType: 'address', type: 'address' },
    ],
    name: 'authorizeBountyGroupAccount',
    outputs: [],
  },
  {
    stateMutability: 'nonpayable',
    type: 'function',
    inputs: [
      { name: 'issuer', internalType: 'bytes32', type: 'bytes32' },
      { name: 'account', internalType: 'address', type: 'address' },
    ],
    name: 'authorizeBountyIssuerAccount',
    outputs: [],
  },
  {
    stateMutability: 'nonpayable',
    type: 'function',
    inputs: [
      { name: '_groupOrIssuer', internalType: 'bytes32', type: 'bytes32' },
      {
        name: '_attestations',
        internalType: 'struct AttestationStation.AttestationData[]',
        type: 'tuple[]',
  ...
  },
  {
    ...
    name: 'revokeBountyIssuerAccount',
    outputs: [],
  },
] as const
 ...
 * -
 */
export const bountiesAttestorAddress = {
  420: '0x7ae3772901ea231949423089d324f1c088172C5e',
 ...
 * -
 */
export const bountiesAttestorConfig = {
  address: bountiesAttestorAddress,
  abi: bountiesAttestorABI,
} as const
...
export const iAttestationStationABI = [
  {
    type: 'event',
    anonymous: false,
    inputs: [
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IBountiesAccessControl
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

export const iBountiesAccessControlABI = [
  { type: 'error', inputs: [], name: 'AddressNotAuthorized' },
  {
    stateMutability: 'nonpayable',
    type: 'function',
...
export const iBountiesAttestorABI = [
  {
    stateMutability: 'nonpayable',
    type: 'function',
    inputs: [
...
/**
 * Wraps __{@link useContract}__ with `abi` set to __{@link bountiesAttestorABI}__.
 *
 * - [__View Contract on Optimism Goerli Etherscan__](https://goerli-optimism.etherscan.io/address/0x7ae3772901ea231949423089d324f1c088172C5e)
 * -
 */
export function useBountiesAttestor(
  config: Omit<UseContractConfig, 'abi' | 'address'> & {
    chainId?: keyof typeof bountiesAttestorAddress
  } = {} as any,
) {
  const { chain } = useNetwork()
  const chainId = config.chainId ?? chain?.id
  return useContract({
    abi: bountiesAttestorABI,
    address:
      bountiesAttestorAddress[chainId as keyof typeof bountiesAttestorAddress],
    ...config,
  })
}

/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link bountiesAttestorABI}__.
 *
 * - [__View Contract on Optimism Goerli Etherscan__](https://goerli-optimism.etherscan.io/address/0x7ae3772901ea231949423089d324f1c088172C5e)
 * -
 */
export function useBountiesAttestorRead<
  TFunctionName extends string,
  TSelectData = ReadContractResult<typeof bountiesAttestorABI, TFunctionName>,
>(
  config: Omit<
    UseContractReadConfig<
      typeof bountiesAttestorABI,
      TFunctionName,
      TSelectData
    >,
    'abi' | 'address'
  > & { chainId?: keyof typeof bountiesAttestorAddress } = {} as any,
) {
  const { chain } = useNetwork()
  const chainId = config.chainId ?? chain?.id
  return useContractRead({
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link bountiesAttestorABI}__ and `functionName` set to `"attestationStation"`.
 *
 * - [__View Contract on Optimism Goerli Etherscan__](https://goerli-optimism.etherscan.io/address/0x7ae3772901ea231949423089d324f1c088172C5e)
 * -
 */
export function useBountiesAttestorAttestationStation<
  TSelectData = ReadContractResult<
    typeof bountiesAttestorABI,
    'attestationStation'
  >,
>(
  ...
  return useContractRead({
    ...
    address:
      bountiesAttestorAddress[chainId as keyof typeof bountiesAttestorAddress],
    functionName: 'attestationStation',
    ...config,
  } as UseContractReadConfig<
    typeof bountiesAttestorABI,
    'attestationStation',
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link bountiesAttestorABI}__ and `functionName` set to `"globalAdmin"`.
 *
 * - [__View Contract on Optimism Goerli Etherscan__](https://goerli-optimism.etherscan.io/address/0x7ae3772901ea231949423089d324f1c088172C5e)
 * -
 */
export function useBountiesAttestorGlobalAdmin<
  TSelectData = ReadContractResult<typeof bountiesAttestorABI, 'globalAdmin'>,
>(
  config: Omit<
    UseContractReadConfig<
      typeof bountiesAttestorABI,
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link bountiesAttestorABI}__ and `functionName` set to `"isAuthorized"`.
 *
 * - [__View Contract on Optimism Goerli Etherscan__](https://goerli-optimism.etherscan.io/address/0x7ae3772901ea231949423089d324f1c088172C5e)
 * -
 */
export function useBountiesAttestorIsAuthorized<
  TSelectData = ReadContractResult<typeof bountiesAttestorABI, 'isAuthorized'>,
>(
  config: Omit<
    UseContractReadConfig<
      typeof bountiesAttestorABI,
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link bountiesAttestorABI}__.
 *
 * - [__View Contract on Optimism Goerli Etherscan__](https://goerli-optimism.etherscan.io/address/0x7ae3772901ea231949423089d324f1c088172C5e)
 * -
 */
export function useBountiesAttestorWrite<
  TMode extends WriteContractMode,
  TFunctionName extends string,
  TChainId extends number = keyof typeof bountiesAttestorAddress,
>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        TMode,
        PrepareWriteContractResult<typeof bountiesAttestorABI, string>['abi'],
        TFunctionName
      > & { address?: `0x${string}`; chainId?: TChainId }
    : UseContractWriteConfig<
        TMode,
  ...
  const { chain } = useNetwork()
  const chainId = config.chainId ?? chain?.id
  return useContractWrite<TMode, typeof bountiesAttestorABI, TFunctionName>({
    abi: bountiesAttestorABI,
    address:
      bountiesAttestorAddress[chainId as keyof typeof bountiesAttestorAddress],
    ...config,
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link bountiesAttestorABI}__ and `functionName` set to `"authorizeBountyGroupAccount"`.
 *
 * - [__View Contract on Optimism Goerli Etherscan__](https://goerli-optimism.etherscan.io/address/0x7ae3772901ea231949423089d324f1c088172C5e)
 * -
 */
export function useBountiesAttestorAuthorizeBountyGroupAccount<
  TMode extends WriteContractMode,
  TChainId extends number = keyof typeof bountiesAttestorAddress,
>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        ...
        PrepareWriteContractResult<
          typeof bountiesAttestorABI,
          'authorizeBountyGroupAccount'
        >['abi'],
        'authorizeBountyGroupAccount'
      > & {
        address?: `0x${string}`
        chainId?: TChainId
        functionName?: 'authorizeBountyGroupAccount'
      }
    : UseContractWriteConfig<
        TMode,
        typeof bountiesAttestorABI,
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link bountiesAttestorABI}__ and `functionName` set to `"authorizeBountyIssuerAccount"`.
 *
 * - [__View Contract on Optimism Goerli Etherscan__](https://goerli-optimism.etherscan.io/address/0x7ae3772901ea231949423089d324f1c088172C5e)
 * -
 */
export function useBountiesAttestorAuthorizeBountyIssuerAccount<
  TMode extends WriteContractMode,
  TChainId extends number = keyof typeof bountiesAttestorAddress,
>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        ...
        PrepareWriteContractResult<
          typeof bountiesAttestorABI,
          'authorizeBountyIssuerAccount'
        >['abi'],
        'authorizeBountyIssuerAccount'
      > & {
        address?: `0x${string}`
        chainId?: TChainId
        functionName?: 'authorizeBountyIssuerAccount'
      }
    : UseContractWriteConfig<
        TMode,
        typeof bountiesAttestorABI,
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link bountiesAttestorABI}__ and `functionName` set to `"bountyAttest"`.
 *
 * - [__View Contract on Optimism Goerli Etherscan__](https://goerli-optimism.etherscan.io/address/0x7ae3772901ea231949423089d324f1c088172C5e)
 * -
 */
export function useBountiesAttestorBountyAttest<
  TMode extends WriteContractMode,
  TChainId extends number = keyof typeof bountiesAttestorAddress,
>(
  config: TMode extends 'prepared'
  ...
  const { chain } = useNetwork()
  const chainId = config.chainId ?? chain?.id
  return useContractWrite<TMode, typeof bountiesAttestorABI, 'bountyAttest'>({
    abi: bountiesAttestorABI,
    address:
      bountiesAttestorAddress[chainId as keyof typeof bountiesAttestorAddress],
    functionName: 'bountyAttest',
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link bountiesAttestorABI}__ and `functionName` set to `"revokeBountyGroupAccount"`.
 *
 * - [__View Contract on Optimism Goerli Etherscan__](https://goerli-optimism.etherscan.io/address/0x7ae3772901ea231949423089d324f1c088172C5e)
 * -
 */
export function useBountiesAttestorRevokeBountyGroupAccount<
  TMode extends WriteContractMode,
  TChainId extends number = keyof typeof bountiesAttestorAddress,
>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        ...
        PrepareWriteContractResult<
          typeof bountiesAttestorABI,
          'revokeBountyGroupAccount'
        >['abi'],
        'revokeBountyGroupAccount'
      > & {
        address?: `0x${string}`
        chainId?: TChainId
        functionName?: 'revokeBountyGroupAccount'
      }
    : UseContractWriteConfig<
        TMode,
        typeof bountiesAttestorABI,
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link bountiesAttestorABI}__ and `functionName` set to `"revokeBountyIssuerAccount"`.
 *
 * - [__View Contract on Optimism Goerli Etherscan__](https://goerli-optimism.etherscan.io/address/0x7ae3772901ea231949423089d324f1c088172C5e)
 * -
 */
export function useBountiesAttestorRevokeBountyIssuerAccount<
  TMode extends WriteContractMode,
  TChainId extends number = keyof typeof bountiesAttestorAddress,
>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        ...
        PrepareWriteContractResult<
          typeof bountiesAttestorABI,
          'revokeBountyIssuerAccount'
        >['abi'],
        'revokeBountyIssuerAccount'
      > & {
        address?: `0x${string}`
        chainId?: TChainId
        functionName?: 'revokeBountyIssuerAccount'
      }
    : UseContractWriteConfig<
        TMode,
        typeof bountiesAttestorABI,
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link bountiesAttestorABI}__.
 *
 * - [__View Contract on Optimism Goerli Etherscan__](https://goerli-optimism.etherscan.io/address/0x7ae3772901ea231949423089d324f1c088172C5e)
 * -
 */
export function usePrepareBountiesAttestorWrite<TFunctionName extends string>(
  config: Omit<
    UsePrepareContractWriteConfig<typeof bountiesAttestorABI, TFunctionName>,
    'abi' | 'address'
  > & { chainId?: keyof typeof bountiesAttestorAddress } = {} as any,
) {
  const { chain } = useNetwork()
  ...
  return usePrepareContractWrite({
    ...
    address:
      bountiesAttestorAddress[chainId as keyof typeof bountiesAttestorAddress],
    ...config,
  } as UsePrepareContractWriteConfig<typeof bountiesAttestorABI, TFunctionName>)
}

/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link bountiesAttestorABI}__ and `functionName` set to `"authorizeBountyGroupAccount"`.
 *
 * - [__View Contract on Optimism Goerli Etherscan__](https://goerli-optimism.etherscan.io/address/0x7ae3772901ea231949423089d324f1c088172C5e)
 * -
 */
export function usePrepareBountiesAttestorAuthorizeBountyGroupAccount(
  config: Omit<
    UsePrepareContractWriteConfig<
      typeof bountiesAttestorABI,
      'authorizeBountyGroupAccount'
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link bountiesAttestorABI}__ and `functionName` set to `"authorizeBountyIssuerAccount"`.
 *
 * - [__View Contract on Optimism Goerli Etherscan__](https://goerli-optimism.etherscan.io/address/0x7ae3772901ea231949423089d324f1c088172C5e)
 * -
 */
export function usePrepareBountiesAttestorAuthorizeBountyIssuerAccount(
  config: Omit<
    UsePrepareContractWriteConfig<
      typeof bountiesAttestorABI,
      'authorizeBountyIssuerAccount'
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link bountiesAttestorABI}__ and `functionName` set to `"bountyAttest"`.
 *
 * - [__View Contract on Optimism Goerli Etherscan__](https://goerli-optimism.etherscan.io/address/0x7ae3772901ea231949423089d324f1c088172C5e)
 * -
 */
export function usePrepareBountiesAttestorBountyAttest(
  config: Omit<
    UsePrepareContractWriteConfig<typeof bountiesAttestorABI, 'bountyAttest'>,
    'abi' | 'address' | 'functionName'
  > & { chainId?: keyof typeof bountiesAttestorAddress } = {} as any,
) {
  const { chain } = useNetwork()
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link bountiesAttestorABI}__ and `functionName` set to `"revokeBountyGroupAccount"`.
 *
 * - [__View Contract on Optimism Goerli Etherscan__](https://goerli-optimism.etherscan.io/address/0x7ae3772901ea231949423089d324f1c088172C5e)
 * -
 */
export function usePrepareBountiesAttestorRevokeBountyGroupAccount(
  config: Omit<
    UsePrepareContractWriteConfig<
      typeof bountiesAttestorABI,
      'revokeBountyGroupAccount'
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link bountiesAttestorABI}__ and `functionName` set to `"revokeBountyIssuerAccount"`.
 *
 * - [__View Contract on Optimism Goerli Etherscan__](https://goerli-optimism.etherscan.io/address/0x7ae3772901ea231949423089d324f1c088172C5e)
 * -
 */
export function usePrepareBountiesAttestorRevokeBountyIssuerAccount(
  config: Omit<
    UsePrepareContractWriteConfig<
      typeof bountiesAttestorABI,
      'revokeBountyIssuerAccount'
...
/**
 * Wraps __{@link useContract}__ with `abi` set to __{@link iAttestationStationABI}__.
 */
export function useIAttestationStation(
  config: Omit<UseContractConfig, 'abi'> = {} as any,
) {
  return useContract({ abi: iAttestationStationABI, ...config })
}

/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link iAttestationStationABI}__.
 */
export function useIAttestationStationWrite<
  TMode extends WriteContractMode,
  TFunctionName extends string,
>(
  config: TMode extends 'prepared'
  ...
  return useContractWrite<TMode, typeof iAttestationStationABI, TFunctionName>({
    abi: iAttestationStationABI,
    ...config,
  } as any)
}

/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link iAttestationStationABI}__ and `functionName` set to `"attest"`.
 */
export function useIAttestationStationAttest<TMode extends WriteContractMode>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        TMode,
        PrepareWriteContractResult<
        ...
        'attest'
      > & { functionName?: 'attest' }
    : UseContractWriteConfig<TMode, typeof iAttestationStationABI, 'attest'> & {
        abi?: never
        functionName?: 'attest'
      } = {} as any,
) {
  return useContractWrite<TMode, typeof iAttestationStationABI, 'attest'>({
    abi: iAttestationStationABI,
    functionName: 'attest',
    ...config,
  } as any)
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link iAttestationStationABI}__.
 */
export function usePrepareIAttestationStationWrite<
  TFunctionName extends string,
>(
  config: Omit<
    UsePrepareContractWriteConfig<typeof iAttestationStationABI, TFunctionName>,
    'abi'
  > = {} as any,
) {
  return usePrepareContractWrite({
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link iAttestationStationABI}__ and `functionName` set to `"attest"`.
 */
export function usePrepareIAttestationStationAttest(
  config: Omit<
    UsePrepareContractWriteConfig<typeof iAttestationStationABI, 'attest'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'attest',
    ...config,
  } as UsePrepareContractWriteConfig<typeof iAttestationStationABI, 'attest'>)
}

/**
 * Wraps __{@link useContractEvent}__ with `abi` set to __{@link iAttestationStationABI}__.
 */
export function useIAttestationStationEvent<TEventName extends string>(
  config: Omit<
    UseContractEventConfig<typeof iAttestationStationABI, TEventName>,
    'abi'
  > = {} as any,
) {
  return useContractEvent({
    abi: iAttestationStationABI,
    ...config,
  } as UseContractEventConfig<typeof iAttestationStationABI, TEventName>)
}

/**
 * Wraps __{@link useContractEvent}__ with `abi` set to __{@link iAttestationStationABI}__ and `eventName` set to `"AttestationCreated"`.
 */
export function useIAttestationStationAttestationCreatedEvent(
  config: Omit<
    UseContractEventConfig<typeof iAttestationStationABI, 'AttestationCreated'>,
    'abi' | 'eventName'
  > = {} as any,
) {
  return useContractEvent({
...
/**
 * Wraps __{@link useContract}__ with `abi` set to __{@link iBountiesAccessControlABI}__.
 */
export function useIBountiesAccessControl(
  config: Omit<UseContractConfig, 'abi'> = {} as any,
) {
  return useContract({ abi: iBountiesAccessControlABI, ...config })
}

/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link iBountiesAccessControlABI}__.
 */
export function useIBountiesAccessControlRead<
  TFunctionName extends string,
  TSelectData = ReadContractResult<
    typeof iBountiesAccessControlABI,
    TFunctionName
  >,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link iBountiesAccessControlABI}__ and `functionName` set to `"isAuthorized"`.
 */
export function useIBountiesAccessControlIsAuthorized<
  TSelectData = ReadContractResult<
    typeof iBountiesAccessControlABI,
    'isAuthorized'
  >,
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link iBountiesAccessControlABI}__.
 */
export function useIBountiesAccessControlWrite<
  TMode extends WriteContractMode,
  TFunctionName extends string,
>(
  config: TMode extends 'prepared'
  ...
  return useContractWrite<
    ...
    typeof iBountiesAccessControlABI,
    TFunctionName
  >({ abi: iBountiesAccessControlABI, ...config } as any)
}

/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link iBountiesAccessControlABI}__ and `functionName` set to `"authorizeBountyGroupAccount"`.
 */
export function useIBountiesAccessControlAuthorizeBountyGroupAccount<
  TMode extends WriteContractMode,
>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link iBountiesAccessControlABI}__ and `functionName` set to `"authorizeBountyIssuerAccount"`.
 */
export function useIBountiesAccessControlAuthorizeBountyIssuerAccount<
  TMode extends WriteContractMode,
>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link iBountiesAccessControlABI}__ and `functionName` set to `"revokeBountyGroupAccount"`.
 */
export function useIBountiesAccessControlRevokeBountyGroupAccount<
  TMode extends WriteContractMode,
>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link iBountiesAccessControlABI}__ and `functionName` set to `"revokeBountyIssuerAccount"`.
 */
export function useIBountiesAccessControlRevokeBountyIssuerAccount<
  TMode extends WriteContractMode,
>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link iBountiesAccessControlABI}__.
 */
export function usePrepareIBountiesAccessControlWrite<
  TFunctionName extends string,
>(
  config: Omit<
    UsePrepareContractWriteConfig<
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link iBountiesAccessControlABI}__ and `functionName` set to `"authorizeBountyGroupAccount"`.
 */
export function usePrepareIBountiesAccessControlAuthorizeBountyGroupAccount(
  config: Omit<
    UsePrepareContractWriteConfig<
      typeof iBountiesAccessControlABI,
      'authorizeBountyGroupAccount'
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link iBountiesAccessControlABI}__ and `functionName` set to `"authorizeBountyIssuerAccount"`.
 */
export function usePrepareIBountiesAccessControlAuthorizeBountyIssuerAccount(
  config: Omit<
    UsePrepareContractWriteConfig<
      typeof iBountiesAccessControlABI,
      'authorizeBountyIssuerAccount'
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link iBountiesAccessControlABI}__ and `functionName` set to `"revokeBountyGroupAccount"`.
 */
export function usePrepareIBountiesAccessControlRevokeBountyGroupAccount(
  config: Omit<
    UsePrepareContractWriteConfig<
      typeof iBountiesAccessControlABI,
      'revokeBountyGroupAccount'
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link iBountiesAccessControlABI}__ and `functionName` set to `"revokeBountyIssuerAccount"`.
 */
export function usePrepareIBountiesAccessControlRevokeBountyIssuerAccount(
  config: Omit<
    UsePrepareContractWriteConfig<
      typeof iBountiesAccessControlABI,
      'revokeBountyIssuerAccount'
...
/**
 * Wraps __{@link useContract}__ with `abi` set to __{@link iBountiesAttestorABI}__.
 */
export function useIBountiesAttestor(
  config: Omit<UseContractConfig, 'abi'> = {} as any,
) {
  return useContract({ abi: iBountiesAttestorABI, ...config })
}

/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link iBountiesAttestorABI}__.
 */
export function useIBountiesAttestorWrite<
  TMode extends WriteContractMode,
  TFunctionName extends string,
>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        TMode,
        PrepareWriteContractResult<typeof iBountiesAttestorABI, string>['abi'],
        TFunctionName
      >
    : UseContractWriteConfig<
        TMode,
        typeof iBountiesAttestorABI,
        TFunctionName
      > & {
        abi?: never
      } = {} as any,
) {
  return useContractWrite<TMode, typeof iBountiesAttestorABI, TFunctionName>({
    abi: iBountiesAttestorABI,
    ...config,
  } as any)
}

/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link iBountiesAttestorABI}__ and `functionName` set to `"bountyAttest"`.
 */
export function useIBountiesAttestorBountyAttest<
  TMode extends WriteContractMode,
>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
  ...
  return useContractWrite<TMode, typeof iBountiesAttestorABI, 'bountyAttest'>({
    abi: iBountiesAttestorABI,
    functionName: 'bountyAttest',
    ...config,
  } as any)
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link iBountiesAttestorABI}__.
 */
export function usePrepareIBountiesAttestorWrite<TFunctionName extends string>(
  config: Omit<
    UsePrepareContractWriteConfig<typeof iBountiesAttestorABI, TFunctionName>,
    'abi'
  > = {} as any,
) {
  return usePrepareContractWrite({
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link iBountiesAttestorABI}__ and `functionName` set to `"bountyAttest"`.
 */
export function usePrepareIBountiesAttestorBountyAttest(
  config: Omit<
    UsePrepareContractWriteConfig<typeof iBountiesAttestorABI, 'bountyAttest'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
